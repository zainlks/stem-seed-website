    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <div class="heading-section ftco-animate">
	            ...
	            <h2 class="mb-4">Virtual Robotics</h2>
	            <p>The virtual robotics program utilizes a software called VEXcode VR. VEXcode VR lets you program a virtual robot using a block based coding environment powered by Scratch Blocks. STEM learning can continue while at home for students with no access to physical robots.</p>
	            <?php checkClassav('Virtual Robotics') ?>
              <p> <strong>Cost: $100 CAD <br> Grades: 4-6 </strong></p>
	          </div>
    			</div>
    				...
    				<div class="row pt-md-3">
    					<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						<h3>6 Weeks</h3>
		    						<p>2 hour sessions <br>Once a week <br><strong>Thursday 3 - 5 p.m.</strong><strong><br>Classes begin the week of June 15th</strong></p>
		    					</div>
		    			...
		    			<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					<div class="icon d-flex justify-content-center align-items-center">
		    						<img class="flaticon-lawn-mower" src = "./assets/electronics.png" height = "60px">
		    					</div>
		    					<div class="text">
		    						<h3>VEXcode VR</h3>
		    						<p>VEXcode VR lets you program a virtual robot using a block based coding environment powered by Scratch Blocks.</p>
		    					</div>
		    					<!-- <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a> -->
		    				</div>
		    			</div>
		    			<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					<div class="icon d-flex justify-content-center align-items-center">
		    						<img class="flaticon-natural-resources" src = "./assets/control.png" height = "60px">
		    					</div>
		    					<div class="text">
		    						<h3>Remote Robot Programming</h3>
		    						<p>Learn the ability to program robots without access to a physical robot.</p>
		    					</div>
		    					<!-- <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a> -->
		    				</div>
		    			</div>
