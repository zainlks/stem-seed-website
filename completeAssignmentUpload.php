...
if(isset($_FILES['contentFile'])) {
  ...
  $newFilePath = "./assignments/$className/".$_FILES["contentFile"]["name"];
  if(move_uploaded_file($_FILES['contentFile']['tmp_name'],"./assignments/$className/".$_FILES["contentFile"]["name"])){
