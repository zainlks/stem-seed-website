    				...
    				<div class="row pt-md-3">
    					<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						<h3>6 Weeks</h3>
		    						<p>1 and a half hour sessions <br>Once a week <br>Every <strong>Monday</strong><br> 12 - 1:30 p.m<strong><br>Classes begin the week of June 15th</strong></p>
		    					</div>
		    			...
		    			<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					<div class="icon d-flex justify-content-center align-items-center">
		    						<img class="flaticon-lawn-mower" src = "./assets/calculator.png" height = "60px">
		    					</div>
		    					<div class="text">
		    						<h3>Wide array of topics</h3>
		    						<p>Covers all areas of math including number sense and numeration, patterning and algebra, geometry, and probability.</p>
		    					</div>
		    					<!-- <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a> -->
		    				</div>
		    			</div>
		    			<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					<div class="icon d-flex justify-content-center align-items-center">
		    						<img class="flaticon-natural-resources" src = "./assets/canada.png" height = "60px">
		    					</div>
		    					<div class="text">
		    						<h3>Ontario Curriculum</h3>
		    						<p>Loosely based on the Ontario math curriculum.</p>
		    					</div>
		    					<!-- <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a> -->
		    				</div>
		    			</div>
