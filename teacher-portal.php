...
<html lang="en">
  ...
  <body>
    <?php session_start(); $teacherClasses = $_SESSION['teacherClasses']; include './include.php'; ?>
                ...
                echo "  <div class=\"col-md-4 d-flex align-items-stretch\">
                    <div class=\"services text-center\">
                      <div class=\"text\">
                        ...
                        <form action=\"./viewClassList.php\" method=\"GET\">
                          <input type=\"hidden\" name=\"className\" id = \"className\" value=\"$teacherClasses[$x]\">
                          <p><input type = \"submit\" class='btn btn-primary py-3 px-4' value = \"View Class List\"></p>
                          </form>
                      </div>
                    </div>
                  </div>";
