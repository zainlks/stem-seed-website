    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <div class="heading-section ftco-animate">
	            ...
	            <h2 class="mb-4">Data Structures and Algorithms</h2>
	            <p>The Data structures and algorithms course introduces complex structures and algorithms to solve programming challenges.</p>
              <?php checkClassav('Data Structures and Algorithms') ?>
              <p> <strong>Cost: $100 CAD <br> Grades: 9 and up </strong></p>
	          </div>
    			</div>
    				...
    				<div class="row pt-md-3">
    					<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						<h3>6 Weeks</h3>
		    						<p>2 hour sessions <br>Once a week <br>Every <strong>Wednesday</strong><br> 7 - 9 p.m<strong><br>Classes begin the week of June 15th</strong></p>
		    					</div>
		    			...
		    			<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					<div class="icon d-flex justify-content-center align-items-center">
		    						<img class="flaticon-lawn-mower" src = "./assets/interface.png" height = "60px">
		    					</div>
		    					<div class="text">
		    						<h3>Complex Structures</h3>
		    						<p>Apply various data structures such as stack, queue, hash table, priority queue, binary search tree, graph and string to solve programming challenges.</p>
		    					</div>
		    					<!-- <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a> -->
		    				</div>
		    			</div>
		    			<div class="col-md-4 d-flex align-items-stretch">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						...
		    						<p>Apply graph and string algorithms to solve real-world challenges: finding shortest paths on huge maps and assembling genomes from millions of pieces.</p>
		    					</div>
		    					<!-- <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a> -->
		    				</div>
		    			</div>
